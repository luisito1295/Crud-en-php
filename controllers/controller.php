...
class MvcController{
	...
	public function getUsers(){
		$usuarios = Datos::getUsers('usuarios');
		...
		foreach ($usuarios as $usuario) {
			echo '<tr>
				...
				<td>'.$usuario["email"].'</td>
				<td><a href="index.php?action=editar&id='.$usuario["id"].'"><button>Editar</button></a></td>
				<td><a href="index.php?action=usuarios&id='.$usuario["id"].'"><button>Borrar</button></a></td>
			</tr>';
		}		
	}
